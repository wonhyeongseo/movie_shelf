...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}" data-toggle="modal" data-target="#trailer">
    ...
    <span>
        ...
        <strong>Description: </strong>{movie_desc} <br>
        <strong>Genre: </strong>{movie_genre} <br>
        <strong>Run Time: </strong>{movie_time} <br>
...
def create_movie_tiles_content(movies):
    ...
    for movie in movies:
        ...
        # Calculate movie run time as a string
        run_time = ''
        hours = movie.run_time//60
        if hours == 0:
            run_time = str(movie.run_time) + "mins"
        elif hours == 1:
            run_time = "1hr " + str(movie.run_time - 60) + "mins"
        elif hours > 1:
            run_time = str(hours) + "hrs " + str(movie.run_time - (60*hours)) + "mins"
        ...
        content += movie_tile_content.format(
            ...
            movie_time=run_time,
            poster_image_url=movie.img_url,
...
def open_movies_page(movies):
    ...
    output_file = open('movie_shelf.html', 'w')
